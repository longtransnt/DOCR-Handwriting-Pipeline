...
class MaskCRNN(object):
    ...
    def predict(self, im, name):
        ...
        if len(pred_masks_list) > 0:
            ...
            cv2.drawContours(temp,[box],0,(0,0,255),2) #Draw Box of Predicted ROI

            # Old Code
            roi_bill_img = four_point_transform(temp, box)
            v = v.draw_instance_predictions(outputs["instances"].to("cpu"))

            # ROI Moust Drag Code
            roi = cv2.selectROI(temp)
...
if __name__ == "__main__":
    ...
    imgs_dir = [
        ...
        r"/home/longtrans/OUCRU-Handwriting-Recognition-reference/Paper_Detection/bill_demo/med_records_det/oof",
