from TextRecognition.vietocr.vietocr.optim.optim import ScheduledOptim
from TextRecognition.vietocr.vietocr.optim.labelsmoothingloss import LabelSmoothingLoss
from torch.optim import Adam, SGD, AdamW
from torch import nn
from TextRecognition.vietocr.vietocr.tool.translate import build_model
from TextRecognition.vietocr.vietocr.tool.translate import translate, batch_translate_beam_search
from TextRecognition.vietocr.vietocr.tool.utils import download_weights
from TextRecognition.vietocr.vietocr.tool.logger import Logger
from TextRecognition.vietocr.vietocr.loader.aug import ImgAugTransform

import yaml
import torch
from TextRecognition.vietocr.vietocr.loader.dataloader_v1 import DataGen
from TextRecognition.vietocr.vietocr.loader.dataloader import OCRDataset, ClusterRandomSampler, Collator
...
#                loss = self.criterion(rearrange(outputs, 'b t v -> (b t) v'), rearrange(tgt_output, 'b o -> (b o)'))
    ...
    def data_gen(self, lmdb_path, data_root, annotation, masked_language_model=True, transform=None):
        print(lmdb_path, data_root, annotation, masked_language_model)
