...
from TextRecognition.ngram.preprocess import preprocess
...
def load_data(data_dir):
    ...
    """
    train_path = data_dir.joinpath('label_train_931.txt').absolute().as_posix()
    test_path = data_dir.joinpath('label_test.txt').absolute().as_posix()
