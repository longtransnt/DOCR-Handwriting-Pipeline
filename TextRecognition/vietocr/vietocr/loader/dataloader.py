from TextRecognition.vietocr.vietocr.tool.translate import resize
from TextRecognition.vietocr.vietocr.tool.create_dataset import createDataset
from TextRecognition.vietocr.vietocr.tool.translate import process_image
...
class OCRDataset(Dataset):
    def __init__(self, lmdb_path, root_dir, annotation_path, vocab, image_height=32, image_min_width=32, image_max_width=512, transform=None):
        ...
        print("anno-path", self.annotation_path)
        self.vocab = vocab
        ...
        print("lmdb_path", self.lmdb_path)
